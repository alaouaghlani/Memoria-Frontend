...
import { updateCloseProfile } from '../../../shared/slice/CloseAdult/CloseAdultService';
import { store } from '../../../shared';
import { setLoggedInUser } from '../../../shared/slice/Auth/AuthSlice';

const ProfileCloseScreen = () => {
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      const res = await updateCloseProfile(data);
        
      if (res.success) {
        store.dispatch(setLoggedInUser({ user: res.close }));
        Toast.show({
          type: 'success',
...
export default ProfileCloseScreen;
